...
const SECTORS = [
  ...
  },
  {
    ...
    description: "Capex financing | Working-capital solutions | EBITDA-based Solutions | Operational turnaround funding | Refinancing & repricing | Debt restructuring.",
    icon: Factory
  },
  {
    title: "Financial Services",
    description: "Capital adequacy support | Book securitization | NCD placements | Funding for disbursement and growth",
    icon: Landmark
  },
  {
    title: "Infrastructure",
    description: "Long-term project finance | Brownfield acquisition financing | Mezzanine debt | Cash-flow discounting | Equity-linked funding structures | Consortium & syndicated financing.",
    icon: Radio
  }
];
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-slate-800">
              ...
              <div className="py-8 md:px-6 md:first:pl-0 flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-[10px] uppercase tracking-widest text-slate-500">Transactions</div>
                </div>
              </div>
              ...
              <div className="py-8 md:px-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-[10px] uppercase tracking-widest text-slate-500">Years Experience</div>
                </div>
              </div>
              ...
              <div className="py-8 md:px-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-[10px] uppercase tracking-widest text-slate-500">Key Partners</div>
                </div>
              </div>
              ...
              <div className="py-8 md:px-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-[10px] uppercase tracking-widest text-slate-500">Network Reach</div>
                </div>
              </div>
