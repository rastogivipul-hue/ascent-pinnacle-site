...
/* FIX: Changed import path to work with a flat file structure.
   Ensure you have 'CountUp.tsx' and 'FadeIn.tsx' in the same folder.
   If these are default exports in your files, remove the curly braces { }.
*/
        ...
        <div className="max-w-4xl">
          <FadeIn>
            ...
            <p className="text-lg text-slate-300 mb-10 leading-relaxed max-w-2xl font-light border-l-2 border-slate-700/50 pl-6">
              ...
              We bridge the gap between institutional capital and distressed opportunities.
            </p>
                ...
                >
                  ...
                  <div>
                    <div className="text-2xl sm:text-3xl font-serif text-white leading-none mb-1">
                      {stat.customDisplay ? stat.customDisplay : (
