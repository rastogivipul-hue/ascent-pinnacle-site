...
const TEAM_MEMBERS = [
  ...
  },
  {
    ...
    bio: [
      "Vipul Rastogi is an investment banking professional with deep expertise in debt syndication, structured financing, and closing complex transactions across real estate, infrastructure, and mid-market sectors. He specializes in unlocking value in illiquid, distressed, and special-situation assets through technical structuring and regulatory arbitrage. Unlike traditional advisors, Vipul focuses on the 'engineering' of a deal—designing the credit protections, ring-fencing cash flows, and mitigating risk before a mandate is ever presented to capital partners.With a robust network across banks, NBFCs, AIFs, family offices, and global investors, Vipul consistently executes high-stakes mandates with speed and precision. Under his leadership, Ascent Pinnacle is transitioning from a boutique advisory into a broader investment platform with a planned Category-II AIF focused on special opportunities and structured credit. He is recognized for his clarity, integrity, and ability to drive outcomes in the most demanding financial environments."
    ]
  },
  {
    name: "Ashish Kumar",
